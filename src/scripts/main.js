...
const playerFieldAttr = document.getElementById("player-field-attr");
const computerFieldCard = document.getElementById("computer-field-card");
const computerFieldAttr = document.getElementById("computer-field-attr");
...
const state = {
  ...
  fieldCards: {
    ...
    playerAttr: playerFieldAttr,
    computer: computerFieldCard,
    computerAttr: computerFieldAttr,
  },
...
function setCardsField(cardId) {
  return RemoveAllCardImages()
    ...
    .then((computerCardId) => {
      ...
      state.fieldCards.playerAttr.textContent = cardData[cardId].type;
      state.fieldCards.computerAttr.textContent = cardData[computerCardId].type;
...
function resetDuel() {
  ...
  state.fieldCards.playerAttr.textContent = "";
  state.fieldCards.computerAttr.textContent = "";
